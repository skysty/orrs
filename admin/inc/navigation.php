              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=buyticket" class="nav-link <?= isset($page) && $page =='schedules' ? "active" : "" ?>">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=pay" class="nav-link nav-inquiries">
                    ...
                    <?php if($_settings->userdata('type') == 1): ?>
                    <li class="nav-header">Техникалық қызмет</li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=schedule" class="nav-link nav-schedules">
                        <i class="nav-icon fas fa-calendar-day"></i>
                        <p>
                          Кесте тізімі
                        </p>
    ...
    $(document).ready(function(){
      ...
      $('#uni_modal').on('shown.bs.modal',function(){
        $('#find-transaction [name="tracking_code"]').focus();
			...
			uni_modal("Бақылау нөмірін енгізіңіз","transaction/find_transaction.php");
		})
    })
  </script>