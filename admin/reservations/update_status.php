        ...
        <input type="hidden" name="id" value="<?= isset($_GET['id']) ? $_GET['id'] : '' ?>">
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control form-control-sm form-control-border" required>
                    <option value="0" <?= isset($status) && $status == 0 ? "selected" : "" ?>>Күтілуде</option>
                    <option value="1" <?= isset($status) && $status == 1 ? "selected" : "" ?>>Расталды</option>
                    <option value="2" <?= isset($status) && $status == 2 ? "selected" : "" ?>>Бас тартылған</option>
                </select>
            </div>
    </form>
</div>
