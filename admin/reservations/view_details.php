...
if(isset($_GET['id'])){
    ...
    if($qry->num_rows > 0){
        ...
        echo '<script> alert("Белгісіз резерв идентификаторлары.");location.replace("./?page=schedules") </script>';
    }
} else{
    echo '<script> alert("Бұл бетті көру үшін брондау идентификаторлары қажет.");location.replace("./?page=schedules") </script>';
}
...
<div class="container-fluid">
        ...
        <div class="list-group-item tickets py-5">
            ...
            <div class="d-flex justify-content-end" id="assignatory">
                <div class="col-md-4">
                    ...
                    <div class="text-center">Басып шығарылған</div>
    ...
    <div class="text-right">
        <button class="btn btn-sm btn-flat btn-success" type="button" id="print"><i class="fa fa-print"></i> Басып шығару</button>
        <button class="btn btn-sm btn-flat btn-dark" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Жабу</button>
    </div>
</div>
