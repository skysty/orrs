...
<div class="container-fluid">
    <form action="" id="train-form">
        ...
        <div class="form-group">
            ...
            <small class='muted'><em>Бұл өрісте (-_) қоспағанда бос орындар мен арнайы таңбаларға рұқсат етілмейді.</em></small>
        </div>
        <div class="form-group">
            <label for="name" class="control-label">Аты</label>
        ...
        <div class="form-group">
            <label for="first_class_capacity" class="control-label">Купе орындық сыйымдылығы</label>
        ...
        <div class="form-group">
            <label for="economy_capacity" class="control-label">Плацкарт орындық сыйымдылығы</label>
