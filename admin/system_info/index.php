...
<div class="col-lg-12">
	<div class="card card-outline card-dark rounded-0 shadow">
		<div class="card-header">
			<h5 class="card-title">Жүйе ақпараты</h5>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="name" class="control-label">Жүйе атауы</label>
				<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
			</div>
			<div class="form-group">
				<label for="short_name" class="control-label">Жүйенің қысқаша атауы</label>
				<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
			</div>
			<div class="form-group">
				<label for="content[about_us]" class="control-label">Сәлемдесу мазмұны</label>
			...
			<div class="form-group">
				<label for="content[about_us]" class="control-label">Біз туралы</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Жүйенің логотипі</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="img" onchange="displayImg(this,$(this))">
	              <label class="custom-file-label" for="customFile">Файлды таңдаңыз</label>
	            </div>
			</div>
