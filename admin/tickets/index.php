...
<div class="content py-5">
    <div class="card rounded-0 card-outline card-primary shadow">
        <div class="card-header rounded-0">
            <h5 class="card-title">Генерациялау бойныша жасалған билеттер</h5>
            <div class="card-tools">
                <button class="btn btn-sm btn-flat btn-success" id="print"><i class="fa fa-print"></i> Басып шығару</button>
            </div>
        </div>
                ...
                <div class="list-group-item tickets py-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <h5 class="m-0 text-center">Брондау билеті</h5>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto pl-4 pr-2"><b>Орындық#:</b></div>
                    ...
                    <div class="row">
                        <div class="col-auto pr-2"><b>Жолаушы аты:</b></div>
