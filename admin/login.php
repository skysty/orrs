      ...
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-sm-12 col-md-6 col-lg-3 card-outline card-primary rounded-0 shadow">
          <div class="card-header rounded-0">
            <h4 class="text-purle text-center"><b>Логин</b></h4>
          </div>
          <div class="card-body rounded-0">
            <form id="login-frm" action="" method="post">
              <div class="input-group mb-3">
                <input type="text" class="form-control" autofocus name="username" placeholder="Пайдаланушы аты">
              ...
              <div class="row">
                <div class="col-8">
                  <a href="<?php echo base_url ?>">Сайтқа өту</a>
                  <li class="nav-item">
                <a href="<?php echo base_url ?>admin/register" class="nav-link">Тіркелу</a>
                </li>
                </div>
                <!-- /.col -->
                <div class="col-4">
