    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">Байланыс телефоны</a>
          </li>
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Dropdown</a>
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="#" class="dropdown-item">Кейбір әрекет </a></li>
              <li><a href="#" class="dropdown-item">Басқа әрекет жасау</a></li>
              ...
              <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  <li>
                    <a tabindex="-1" href="#" class="dropdown-item">Деңгей 2</a>
                  </li>
                  ...
                  <li class="dropdown-submenu">
                    ...
                    <ul aria-labelledby="dropdownSubMenu3" class="dropdown-menu border-0 shadow">
                      <li><a href="#" class="dropdown-item">3-ші деңгей</a></li>
                      <li><a href="#" class="dropdown-item">3-ші деңгей</a></li>
                    </ul>
                  </li>
                  <!-- End Level three -->

                  <li><a href="#" class="dropdown-item">Деңгей 2</a></li>
                  <li><a href="#" class="dropdown-item">Деңгей 2</a></li>
                </ul>
              </li>
              <!-- End Level two -->
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm">Мүмкіндігінше маған қоңырау шалыңыз...</p>
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 сағат бұрын</p>
                </div>
              </div>
              <!-- Message End -->
            </a>
